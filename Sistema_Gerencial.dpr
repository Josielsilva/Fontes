...
uses
  ...
  uMan in 'Principal\uMan.pas' {FrmMan},
  ...
  uRelReceitaPorTipo in 'Relatórios\uRelReceitaPorTipo.pas' {frmRelReceitaPorTipo},
  ...
  uDespesaPorData in 'TelaRelatórios\uDespesaPorData.pas' {frmDespesaPorData},
  uDespesaPorTipo in 'TelaRelatórios\uDespesaPorTipo.pas' {frmDespesaPorTipo},
  ...
  uReceitaPorData in 'TelaRelatórios\uReceitaPorData.pas' {frmReceitaPorData},
  uReceitaPorTipo in 'TelaRelatórios\uReceitaPorTipo.pas' {frmReceitaPorTipo},
  uRelDespesaPorTipo in 'Relatórios\uRelDespesaPorTipo.pas' {frmRelDespesaPorTipo},
  uRelReceitaPorData in 'Relatórios\uRelReceitaPorData.pas' {frmRelReceitaPorData},
  uRelDespesaPorData in 'Relatórios\uRelDespesaPorData.pas' {frmRelDespesaPorData},
  uRelProVendaPorData in 'Relatórios\uRelProVendaPorData.pas' {frmRelProVendPorData},
  uRelVendaPorCliente in 'Relatórios\uRelVendaPorCliente.pas' {frmVendaCliente},
  uVendaPorCliente in 'TelaRelatórios\uVendaPorCliente.pas' {frmVendCliente},
  uCadClientes in 'Cadastros\uCadClientes.pas' {frmCadCliente},
  uArquivosIni in 'Ini\uArquivosIni.pas',
  uAcaoAcesso in 'Classes\cAcaoAcesso.pas',
  uBuscaCep in 'BuscaCep\uBuscaCep.pas',
  Pkg.Json.DTO in 'BuscaCep\Pkg.Json.DTO.pas',
  uCadastroForncedor in 'Classes\uCadastroForncedor.pas';
