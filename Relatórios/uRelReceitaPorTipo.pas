...
type
  TfrmRelReceitaPorTipo = class(TForm)
    Relatorio: TRLReport;
    Cabecalho: TRLBand;
    RLLabel1: TRLLabel;
    RLDraw1: TRLDraw;
...
var
  frmRelReceitaPorTipo: TfrmRelReceitaPorTipo;
...
procedure TfrmRelReceitaPorTipo.FormDestroy(Sender: TObject);
begin
  QryReceita.Close;
end;
