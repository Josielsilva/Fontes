inherited frmCadSubGrupo: TfrmCadSubGrupo
  ...
  inherited Panel3: TPanel
    ...
    inherited pgcPadrao: TPageControl
      ...
      inherited TabSheet2: TTabSheet
        ...
        object btnIncluirGrupo: TSpeedButton
          Left = 675
          Top = 64
          Width = 23
          Height = 22
        ...
        object btnPesquisarGrupo: TSpeedButton
          Left = 703
          Top = 63
          Width = 23
          Height = 22
          Glyph.Data = {
            ...
            00FFFF00FFFF00FFFF00FFFF00FFFF00FFFF00FFFF00FFFF00FF}
          OnClick = btnPesquisarGrupoClick
        end
        ...
        object lbkCodGrupo: TDBLookupComboBox
          Left = 545
          Top = 64
          Width = 130
          Height = 21
  ...
  inherited zqPrincipal: TZQuery
    ...
    SQL.Strings = (
      ...
      '     FROM'
      '      SUBGRUPO')
    object zqPrincipalSubGrupo_Cod: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'SubGrupo_Cod'
      ReadOnly = True
    end
    object zqPrincipalSubGrupo_Nome: TWideStringField
      DisplayLabel = 'Nome'
      FieldName = 'SubGrupo_Nome'
      Size = 15
    end
    object zqPrincipalSubGrupo_Descricao: TWideStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'SubGrupo_Descricao'
      Size = 50
    end
    object zqPrincipalSubGrupo_GrupoId: TIntegerField
      DisplayLabel = 'C'#243'digo do Grupo'
      FieldName = 'SubGrupo_GrupoId'
    end
  end
