...
uses
  ...
  ZAbstractDataset, ZDataset, Vcl.StdCtrls, Vcl.DBCtrls,Enter,uEnun,
   Vcl.Mask,RxCurrEdit, RxToolEdit;
...
type
  TfrmPadrao = class(TForm)
    ...
    procedure medtPesquisaClick(Sender: TObject);
  private
...
procedure TfrmPadrao.medtPesquisaClick(Sender: TObject);
begin
 if Trim(medtPesquisa.Text) = 'Digite sua Pesquisa'then
   medtPesquisa.Text:= '';
end;
