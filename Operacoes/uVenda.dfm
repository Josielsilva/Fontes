inherited frmVendas: TfrmVendas
  ...
  inherited Panel3: TPanel
    ...
    inherited pgcPadrao: TPageControl
      ...
      inherited TabSheet2: TTabSheet
        ...
        object btnPesquisarOrcamento: TSpeedButton
          Left = 153
          Top = 21
          Width = 23
          Height = 22
        ...
        object edtCodigoVenda: TLabeledEdit
          Tag = 1
          Left = 5
          Top = 63
          Width = 119
        ...
        object lkpVeiculo: TDBLookupComboBox
          ...
          ListSource = DtmOperacaoVenda.dsVeiculo
          TabOrder = 5
        ...
        object dbgVenda: TDBGrid
          ...
          Height = 220
          Align = alBottom
          DataSource = DtmOperacaoVenda.dtsItensVenda
          TabOrder = 6
  ...
  inherited zqPrincipal: TZQuery
    ...
    Left = 248
    Top = 208
    object zqPrincipalVend_Id: TIntegerField
      DisplayLabel = 'Venda'
      FieldName = 'Vend_Id'
      ReadOnly = True
    end
    object zqPrincipalVend_Status: TWideStringField
      DisplayLabel = 'Status'
      FieldName = 'Vend_Status'
      Required = True
      Size = 10
    end
    object zqPrincipalVend_CodCli: TIntegerField
    ...
    object zqPrincipalVend_DataVenda: TDateTimeField
      DisplayLabel = 'Data da venda'
      FieldName = 'Vend_DataVenda'
      ReadOnly = True
    end
    object zqPrincipalVend_TotalVenda: TFloatField
    ...
    object zqPrincipalCli_Telefone1: TWideStringField
      DisplayLabel = 'Telefone do cliente'
