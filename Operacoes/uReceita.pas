...
uses
  ...
  RxCurrEdit,uDtmPrincipal,uReceitas,uEnun,uUsuarioLogado, ZAbstractRODataset,
...
begin
  inherited;
     ...
     edtDataVencimento.date :=vReceita.DataVencimento;
     edtValor.Text          :=FloatToStr(vReceita.Valor);
     cbReceita.Text         :=vReceita.Status;
...
begin
  ...
  vReceita.DataVencimento     := edtDataVencimento.date;
  vReceita.valor              := StrToFloat(edtValor.text);
  vReceita.Status             := cbReceita.Text;
