...
procedure TfrmOrcamento.lkpClienteExit(Sender: TObject);
begin
  inherited;
...
Procedure TfrmOrcamento.CarregaVeiculo(PCliente : Integer);
begin
  DtmOrcamentos.qryVeiculo.Close;
  DtmOrcamentos.qryVeiculo.ParamByName('PCLIENTE').AsInteger := PCliente;
...
begin
  inherited;
  if lkpProduto.Text<>EmptyStr then begin
    DtmOrcamentos.QryProduto.Close;
    DtmOrcamentos.QryProduto.ParamByName('PProd_cod').AsInteger := StrToInt(lkpProduto.Text);
    DtmOrcamentos.QryProduto.Open;
...
begin
 Result:=False;
  ...
  frmRelProOrcamento.QryVeiculo.Close;
  frmRelProOrcamento.QryVeiculo.ParamByName('PVEIC_COD').AsInteger:= vOrcamento.Veiculo;
  frmRelProOrcamento.QryVeiculo.Open;

  frmRelProOrcamento.QryEmpresa.Close;
  frmRelProOrcamento.QryEmpresa.Open;
