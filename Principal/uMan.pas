...
begin
  ...
  if MessageBox(Handle,'Deseja atualizar o sistema?','Atualização' ,MB_YESNO +MB_DEFBUTTON2+ MB_ICONINFORMATION) = IDYES then
  begin
...
begin
    try
     Image1.Picture.LoadFromFile(ExtractFilePath(Application.ExeName)+'logo.jpg');
      ...
      MessageDlg('Logotipo não encontrado na pasta do sistema!',mtInformation,[mbOK],0);
    end;
