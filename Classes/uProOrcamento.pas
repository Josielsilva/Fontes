...
begin
  try
    ...
    Qry.SQL.Add('UPDATE OrcamentoItens '+
                ...
                '      ,OrcItens_TipoPeca      =:OrcItens_TipoPeca'+
                '      ,OrcItens_ProdId        =:OrcItens_ProdId'  +
    ...
    Qry.ParamByName('OrcItens_TipoPeca').AsString    :=Cds.FieldByName('OrcItens_TipoPeca').AsString;
    Qry.ParamByName('OrcItens_ProdId').AsInteger     :=Cds.FieldByName('OrcItens_ProdId').AsInteger;
