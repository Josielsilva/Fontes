...
begin
    ...
    Qry.ParamByName('OrcItens_prodId').AsInteger    :=Self.F_OrcamentoId;
    Try
...
procedure TOrcamento.GravaReceita(pIdOrcamento,pCliente:Integer;pValor:Double;pStatus:String);
var Qry:TZQuery;
begin
  try
    Qry:=TZQuery.Create(nil);
    ...
    Qry.ParamByName('Rec_Descricao').AsString      := 'Recebimento do Orçamento: '+ IntToStr( pIdOrcamento) + 'do Cliente :'+IntToStr(pCliente);
