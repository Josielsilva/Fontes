...
begin
  try
    ...
    Qry.SQL.Add('SELECT acesso_id FROM acesso ');
    Qry.Open;
    ...
    begin
      ...
      begin
        VerificarUsuarioAcao(Qry.FieldByName('acesso_id').AsInteger, QryAcaoAcesso.FieldByName('acaoAcessoId').AsInteger, aConexao);
        QryAcaoAcesso.Next;
      end;
