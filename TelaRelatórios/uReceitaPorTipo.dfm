object frmReceitaPorTipo: TfrmReceitaPorTipo
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio de receita por tipo'
  ClientHeight = 98
  ClientWidth = 271
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtTipoInicio: TLabeledEdit
      Left = 8
      Top = 32
      Width = 97
      Height = 21
      EditLabel.Width = 39
      EditLabel.Height = 13
      EditLabel.Caption = 'Tipo de:'
      TabOrder = 1
    end
    object EdtTipoFim: TLabeledEdit
      Left = 159
      Top = 32
      Width = 97
      Height = 21
