...
// (DO NOT EDIT: machine generated header) 'Acshellctrls.pas' rev: 21.00
...
#define SShellNoDetails L"Unable to retrieve folder details for \"%s\". Error code $"\
	L"%x"
#define NTFolders (Set<TacRootFolder, rfDesktop, rfTemplates> () << rfCommonDesktopDirectory << rfCommonPrograms << rfCommonStartMenu << rfCommonStartup )
extern PACKAGE StaticArray<int, 23> nFolder;
