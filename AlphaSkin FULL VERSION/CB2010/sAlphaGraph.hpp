...
extern PACKAGE Graphics::TColor __fastcall CorrectColor32 [[deprecated]](Graphics::TColor Color);
...
extern PACKAGE void __fastcall FillAlphaRect(const Graphics::TBitmap* Bmp, const Types::TRect &R, System::Byte Value, bool SkipFuchsia = false);
