...
public:
	...
	virtual void __fastcall AddNewItem(const Controls::TWinControl* Ctrl, const System::UnicodeString SkinSection)/* overload */;
...
public:
	...
	System::Byte CurrentBlendValue;
	System::Byte BlendStep;
	TsSkinProvider* SP;
	TacBorderForm* BorderForm;
	unsigned FormHandle;
...
public:
	...
	double DeltaW;
	double DeltaH;
	System::Byte AlphaOrigin;
	System::Byte AlphaFrom;
	System::Byte AlphaTo;
	System::Byte CurrentAlpha;
	double BlendStep;
	...
	Types::TRect __fastcall GetRectTo(void);
...
//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt UserButtonsOffset = 0x8;
...
static const System::Word FS_MAXBOUNDS = 0x6000;
