...
// (DO NOT EDIT: machine generated header) 'sStatusBar.pas' rev: 22.00
...
protected:
	...
	void __fastcall InternalDrawPanel(Comctrls::TStatusPanel* Panel, System::UnicodeString Text, const Types::TRect &Rect);
	void __fastcall DoDrawText(const System::UnicodeString Text, Types::TRect &Rect, int Flags);
