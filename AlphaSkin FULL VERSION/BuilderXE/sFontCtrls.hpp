...
// (DO NOT EDIT: machine generated header) 'sFontCtrls.pas' rev: 22.00
...
typedef System::DynamicArray<TFontClass*> TFontsArray;

typedef System::StaticArray<Graphics::TBitmap*, 4> TBitmapArray;
