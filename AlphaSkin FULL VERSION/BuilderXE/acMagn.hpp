...
// (DO NOT EDIT: machine generated header) 'acMagn.pas' rev: 22.00
...
protected:
	...
	Types::TRect __fastcall BordersWidth(void);
...
public:
	...
	Types::TRect __fastcall ContentMargins(void);
	void __fastcall FormCreateInit(void);
	tagSIZE __fastcall MagnSize(void);
	Types::TRect __fastcall MClientRect(void);
	int __fastcall MinSize(void);
	__fastcall virtual ~TacMagnForm(void);
	void __fastcall EstablishAspectRatio(System::Word Side, Types::TRect &Rect);
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word amMaxSize = 0x320;
static const System::Byte amMinSize = 0x96;
