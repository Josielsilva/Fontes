...
struct DECLSPEC_DRECORD TKernel
{
	
public:
	TKernelSize Size;
	System::StaticArray<float, 201> Weights;
};


//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt MaxKernelSize = 0x64;
...
extern PACKAGE void __fastcall PaintSmallItem(int SkinIndex, const System::UnicodeString SkinSection, const Sconst::TCacheInfo &ci, bool Filling, int State, const Types::TRect &R, const Types::TPoint &pP, Graphics::TBitmap* ItemBmp, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
...
extern PACKAGE void __fastcall acWriteTextEx(const Graphics::TCanvas* Canvas, System::WideChar * Text, bool Enabled, Types::TRect &aRect, unsigned Flags, Scommondata::TsCommonData* SkinData, bool Hot, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall acWriteTextEx(const Graphics::TCanvas* Canvas, System::WideChar * Text, bool Enabled, Types::TRect &aRect, unsigned Flags, int SkinIndex, bool Hot, System::TObject* SkinManager = (System::TObject*)(0x0))/* overload */;
extern PACKAGE void __fastcall acWriteText(const Graphics::TCanvas* Canvas, System::WideChar * Text, bool Enabled, Types::TRect &aRect, unsigned Flags);
...
extern PACKAGE void __fastcall SumBitmapsByMask(Graphics::TBitmap* &ResultBmp, Graphics::TBitmap* &Src1, Graphics::TBitmap* &Src2, Graphics::TBitmap* MskBmp, System::Word Percent = (System::Word)(0x0));
...
extern PACKAGE Graphics::TBitmap* __fastcall CreateBmp24 [[deprecated]](const int Width, const int Height);
...
extern PACKAGE tagSIZE __fastcall GetStringSize(HGDIOBJ hFont, const System::UnicodeString Text);
