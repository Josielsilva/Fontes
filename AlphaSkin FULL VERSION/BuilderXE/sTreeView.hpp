...
// (DO NOT EDIT: machine generated header) 'sTreeView.pas' rev: 22.00
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE Comctrls::TTreeNode* __fastcall GetNodeByText(const Comctrls::TCustomTreeView* TreeView, const System::UnicodeString s);
