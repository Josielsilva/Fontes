...
// (DO NOT EDIT: machine generated header) 'Acshellctrls.pas' rev: 10.00
...
#define SShellNoDetails "Unable to retrieve folder details for \"%s\". Error code "\
	"$%x"
#define NTFolders (Set<TacRootFolder, rfDesktop, rfTemplates> () << TacRootFolder(5) << TacRootFolder(6) << TacRootFolder(7) << TacRootFolder(8) )
